  ...
  return (
    <>
      ...
      <div className="relative px-10 pt-6">
        <a
          href="https://discord.gg/hsmP3SwCD3"
          target="_blank"
          className="flex items-center gap-2 text-text-secondary/60 hover:text-gold transition-colors text-sm"
        >
          ...
          <span className="font-heading text-xs uppercase tracking-[0.15em]">Discord</span>
        </a>
      </div>
